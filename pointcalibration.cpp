/*
pointcalibration.cpp - LTmgc (Ludique's TUIO Multiplexer, Gestures and Screen Calibrator)
...
pointcalibration::pointcalibration(calibrationskt* cal,int numP,double distBor,int numFrames,bool* working,QWidget *parent) :
    QWidget(parent),
