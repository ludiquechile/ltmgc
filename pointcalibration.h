/*
pointcalibration.h - LTmgc (Ludique's TUIO Multiplexer, Gestures and Screen Calibrator)
...
public:
    explicit pointcalibration(calibrationskt* cal, int numP,double distBor,int numFrames,bool* working=NULL,QWidget *parent = 0);
    ~pointcalibration();
